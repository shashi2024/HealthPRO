...
import Navigation from "./components/Navigation"; // Sidebar or extra nav?
// add all your other imports...
      ...
      <Outlet /> 
        <Routes>
          ...
          <Route path="" element={<PrivateRoute />}>
            ...
            <Route
              path="/recommendDoctors"
              element={<RecommendationDoctors />}
            />
            <Route
            ...
            <Route
              ...
              element={<EmergencyRequestScreen />}
            />
          ...
          <Route path="" element={<ManagementPrivateRoute />}>
            ...
            <Route
              path="/managementdashboard/overview"
              element={<Overview />}
            />
            <Route
              path="/managementdashboard/patients"
              element={<Patients />}
            />
            <Route
            ...
            <Route
              path="/managementdashboard/payments"
              element={<Payments />}
            />
            <Route
            ...
            />
            <Route
              path="/managementdashboard/emergency"
              element={<Emergency />}
            />
            ...
            />
            <Route
              path="/admin/assign-ambulance/:requestId"
              element={<Assign />}
            />
            <Route
              path="/admin/emergency-report"
